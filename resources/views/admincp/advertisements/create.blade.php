    ...
    <div class="container" style="width:95%;">
        ...
        <div class="row">
            ...
            <div class="col s12 xl9">
                <div class="card">
                    <div class="card-content">
                    <form method="POST" action="{{ route('admincp.advertisements.create') }}">
                        @csrf
                        <div class="input-field" style="margin-bottom: 20px;">
                            ...
                            <input class="input-field" type="text" name="website" required>
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            ...
                            <small>The referring prefix that will appear after your URL.</small><br>
                             ...
                             <input class="input-field" type="text" name="link" required>
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            <span>Cost</span><br>
                            ...
                            <small style="color:#c9aa71">This cost should be based on 30 days of the advertisement running. If the advertisement is free, simply enter 0 here.</small>
                             <input class="input-field" type="text" name="cost" required>
                        </div>
                        <hr>
