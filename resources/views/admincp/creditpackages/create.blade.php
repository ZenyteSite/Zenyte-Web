    ...
    <div class="container" style="width:95%;">
        ...
        <div class="row">
            ...
            <div class="col s12 xl9">
                <div class="card">
                    <div class="card-content">
                    <form method="POST" action="{{ route('admincp.creditpackages.create') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="input-field" style="margin-bottom: 20px;">
                            <span>Credits Amount</span><br>
                            <small>The amount of credits a user should receive when they purchase this</small>
                            <input class="input-field" type="text" name="amount" required>
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            ...
                            <input class="input-field" type="text" name="bonus">
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            ...
                            <input class="input-field" type="text" name="holiday_bonus">
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            ...
                            <input class="input-field" type="text" name="discount" max="99.9">
                        </div>
                        <div class="input-field" style="margin-bottom: 20px;">
                            <span>Price ($)</span><br>
                        ...
                        <div class="file-field input-field">
                            <div class="btn">
                                ...
                                <input type="file" name="credit-image" required>
                            </div>
