    ...
    <div class="container" style="width:95%;">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="row" style="margin: 0;">
                            <h5 class="left category-title">Mod Control Panel - OSGP</h5>
        ...
        <div class="row">
            ...
            <div class="col s12 xl9">
                ...
                <form method="POST" action="{{ route('modcp.osgp') }}">
                    @csrf
                    <div class="input-field">
                        <input type="text" id="username" name="username" placeholder="Search by character name" required>
...
<div id="modal3" class="modal">
    <form method="POST" action="{{ route('modcp.osgp.submit') }}">
        @csrf
